...
- **Geo** — apartment locations plotted with the ArcGIS Maps for Power BI visual (used instead of Azure Maps, which requires a Microsoft work/school account).
  ...
  ![Geo page](docs/screenshots/geo_page.png)
  *Listing density across the 8 MVP cities, colored by market type.*
...
## Roadmap / Future Improvemenclustered on `source_city`, `WRITE_APPEND`.

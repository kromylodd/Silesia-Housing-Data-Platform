...
<img width="1281" height="722" alt="page1" src="https://github.com/user-attachments/assets/ee2625cb-a465-453d-9b63-0c11eb09c896" />

<img width="589" height="723" alt="page2" src="https://github.com/user-attachments/assets/0b2b2b70-0b3e-40a7-bae4-3cecfb8ccdf2" />
...
- **Overview** — KPI cards (average price, average price/m², median price, listings count), an average-price trend line, a listings-volume-over-time line, and a Top Cities by average price bar chart with a Top N slicer.
- **Market** — primary vs. secondary market comparison on a dual-axis chart, driven by `dim_market`.
- **Geo** — apartment locations plotted with the ArcGIS Maps for Power BI visual (used instead of Azure Maps, which requires a Microsoft work/school account).
